 ...
 */
$config['site_title']                 = "BadGeek";       // Site Title, example.com
$config['admin_email']                = "nemo.emmanuel@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'poditeurs';           // Default group, use name
